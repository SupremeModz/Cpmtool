...
from supremecpm1 import SupremeModz

__CHANNEL_USERNAME__ = "SUPREMEMODZTOOLS=CHANNEL"
__GROUP_USERNAME__   = "SUPREMEMODZTOOLS=GROUP"
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = SupremeModz(acc_access_key)
